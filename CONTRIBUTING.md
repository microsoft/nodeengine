# Contributing to Node Engine

You can contribute to Node Engine with issues and pull requests (PRs).
...
[issues page](https://github.com/microsoft/nodeengine/issues).
...
Project maintainers will decide whether to accept and merge code changes from contributors.
...
- **DON'T** commit code that you didn't write. If you find code that you think is a good
  fit to add, file an issue and start a discussion before proceeding.
...
that include breaking changes might be rejected. Please file an issue to discuss
...
2. Create a personal fork of the repository on GitHub (if you don't already have one).
   - In your GitHub fork enable Secret scanning
